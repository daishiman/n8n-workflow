...
- **Sticky Note**: グループの説明ノード。目的/背景だけでなく `### 🔗 関連ノードブロック` で所属ノードの役割・前後関係・主要データを記述し、視覚的なグループ仕様書として機能させる
...
- Sticky Note必須: 各グループに1つのSticky Noteを配置し、メインフローは色2/3/4/6・エラーフローは色5（白系0/1禁止）、最低540×420で全文が表示されるサイズに整えること
